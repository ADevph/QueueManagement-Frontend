  ...
  const onSubmit = async () => {
    ...
    if (!firstName) {
      ...
      if (!setFirstNameError.test(firstName)) {
        setFirstNameError(
          "First name can only contain letters, numbers, and spaces. Maximum length is 20 characters."
        );
        setLoading(false);
        return;
      }
    ...
    if (!lastName) {
      ...
      if (!setFirstNameError.test(lastName)) {
        setLastNameError(
          "Last name can only contain letters, numbers, and spaces. Maximum length is 20 characters."
        );
        setLoading(false);
        return;
      }
